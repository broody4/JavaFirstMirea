        ...
        public void draw(Graphics g){
            ...
            for (int i=0;i<700;i+=175) {
                for (int j = 0; j < 500; j += 140) {
                    ...
                    int k = gen.nextInt(3);
                    if (k == 0) {
                        Circle obj = new Circle(10+gen.nextDouble(40));
                    ...
                    if (k == 1) {
                        Rectangle obj = new Rectangle(20+gen.nextDouble(80),
                                20+gen.nextDouble(80));
                    ...
                    if (k == 2) {
                        Square obj = new Square(20+gen.nextDouble(80));
